...
/*
INSERT INTO RssItems (link) VALUES ('http://blog.saltfactory.net')
WHERE NOT EXISTS (SELECT id FROM RssItems WHERE link='http://blog.saltfactory.net')
*/
/*
own_user_id: '44',
  src: 'http://cfile28.uf.tistory.com/image/20327040509B9ED80966D9',
  width: 420,
  height: 275,
  tags: [ { name: '개같은' }, { name: '지상렬' }
*/
